...
//
// Lives in lib/ (not directly in netlify/functions/) so Netlify doesn't
// try to deploy it as its own standalone function — it has no `handler`
// export, it's only ever require()'d by push-send.js.
